...
_defineProperty(KalturaPlayerAPI, "setup", async function () {
...
async function setupKalturaPlayer(id, options) {
  try {
    const kalturaPlayerSetup = await KalturaPlayerModule.setUpPlayer(id, options);
