...
_defineProperty(KalturaPlayerAPI, "setup", async function (playerType) {
...
_defineProperty(KalturaPlayerAPI, "loadMedia", (id, asset) => {
  if (!id || !asset) {
...
async function setupKalturaPlayer(type, id, options) {
  try {
    const kalturaPlayerSetup = await KalturaPlayerModule.setUpPlayer(type, id, options);
