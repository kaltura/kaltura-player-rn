...
_defineProperty(KalturaPlayerAPI, "setup", _ref => {
  let {
    options,
    partnerId
  } = _ref;
...
_defineProperty(KalturaPlayerAPI, "load", _ref2 => {
  let {
    assetId,
    options
  } = _ref2;
...
_defineProperty(KalturaPlayerAPI, "setMedia", mediaEntry => {
  return KalturaPlayerModule.setMedia(mediaEntry);
});

_defineProperty(KalturaPlayerAPI, "playNewMedia", options => {
...
_defineProperty(KalturaPlayerAPI, "setMaxBitrate", bitrate => {
  return KalturaPlayerModule.setMaxBitrate(bitrate);
});

_defineProperty(KalturaPlayerAPI, "updateLoadControlBuffers", () => () => {});
