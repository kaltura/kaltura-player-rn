...
//   }
//
//   @ReactProp(name = "rnview")
//   public void sendView(KalturaPlayerRNView kalturaPlayerRNView, boolean isVisible) {
//      //kalturaPlayerRNView.setVisibility(View.VISIBLE);
//      Log.d("Gourav", "I am a Prop 2.");
//   }
//
//   @ReactMethod(isBlockingSynchronousMethod = true)
//   public void setup(int partnerId, String options) {
//      log.d("setup");
//      UiThreadUtil.runOnUiThread(() -> {
//         kalturaPlayerRNView = new KalturaPlayerRNView(context);
//        // player = kalturaPlayerRNView.setup(partnerId, options);
//
...
//
//   @ReactMethod(isBlockingSynchronousMethod = true)
//   public void load(String assetId, String options) {
//      log.d("load");
//      UiThreadUtil.runOnUiThread(() -> {
//       //  kalturaPlayerRNView.load(assetId, options);
//      });
//   }
//
//   @ReactMethod(isBlockingSynchronousMethod = true)
...
//         UiThreadUtil.runOnUiThread(() -> {
//            player.getPlayerView().setVisibility(isVisible ? View.VISIBLE : View.INVISIBLE);
//         });
//      }
//   }
//
...
//
//  /* @ReactMethod(isBlockingSynchronousMethod = true)
//   public void setupKalturaBasicPlayer(String url) {
//      log.d( "setupKalturaBasicPlayer");
//      log.d( "Playback URL is : " + url);
//
//      getCurrentActivity().runOnUiThread(new Runnable() {
//         @Override
//         public void run() {
//            loadKalturaBasicPlayer(url);
//         }
//      });
//   }
//
...
//   }
//
//   public void loadKalturaBasicPlayer(String url) {
//      log.d( "loadKalturaBasicPlayer");
//
...
//
//   @ReactMethod(isBlockingSynchronousMethod = true)
//   public void setup1(int partnerId, String jsonOptionsStr) {
//
...
//
//   @ReactMethod(isBlockingSynchronousMethod = true)
//   public void load1(String assetId, String jsonOptionsStr) {
//
...
//   }
//*/
//   private void addActivityLifeCycleListeners(ReactApplicationContext context) {
